...
export default function ModeleEditor({
  ...
  return (
    <div className="rounded-xl border border-white/10 p-6 space-y-5" style={{ background: "#24385E" }}>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-slate-300 text-xs mb-1.5">Nom du modèle *</label>
          <input
            type="text"
            value={form.nom}
        ...
        <div>
          <label className="block text-slate-300 text-xs mb-1.5">
            Moment de la séquence <span className="text-slate-400">(indicatif)</span>
          </label>
          <input
            type="text"
            value={form.moment}
      ...
      <div>
        <label className="block text-slate-300 text-xs mb-1.5">Objectif du message</label>
        <input
          type="text"
          value={form.objectif}
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        <div>
          <label className="block text-slate-300 text-xs mb-1.5">Expéditeur par défaut</label>
          <input
            type="text"
            value={form.fromName}
        ...
        <div>
          <label className="block text-slate-300 text-xs mb-1.5">Adresse de réponse</label>
          <input
            type="email"
            value={form.replyTo}
        ...
        <div>
          <label className="block text-slate-300 text-xs mb-1.5">
            Délai conseillé <span className="text-slate-400">(jours)</span>
          </label>
          <input
            type="number"
            min={0}
      ...
      {/* ── Rédaction + aperçu en direct (même rendu que l'envoi réel) ── */}
      <div className="grid lg:grid-cols-2 gap-5 items-start">
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <span className="text-slate-400 text-[11px]">
              ...
              Repli : <code className="text-slate-300">{"{{ville|votre secteur}}"}</code>
            </span>
          </div>
        ...
        <div className="min-w-0 lg:sticky lg:top-4">
          <ApercuEmail sujet={form.sujet} contenu={form.contenu} fromName={form.fromName} />
        </div>
      </div>
